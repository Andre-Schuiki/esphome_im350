...
iskra_am550_ns = cg.esphome_ns.namespace('iskra_am550')
SmartMeterSensorComponent = iskra_am550_ns.class_('SmartMeterSensorComponent', sensor.Sensor, cg.PollingComponent)
